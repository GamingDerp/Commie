            ...
            for user_id in user_ids:
                ...
                for word in words:
                    if word in content and not any(ignored_word in content for ignored_word in ignored_words):
                        if member and self.check_for_access(member, message.channel):
                            e = discord.Embed(title=f"🚨 Word Mentioned 🚨", color=commie_color, timestamp=datetime.utcnow())
